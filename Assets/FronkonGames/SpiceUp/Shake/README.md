...
1. Read the documentation at folder '_FronkonGames/SpiceUp/Shake/Documentation_' or visit the [online version](https://fronkongames.github.io/store/spiceup.html).
2. Open the scene at folder '_FronkonGames/SpiceUp/Shake/Demo/_'.
