...
namespace FronkonGames.SpiceUp.Shake
{
  ...
  public sealed partial class Shake
  {
    ...
    private static readonly Shake[] NoEffects = new Shake[0];
    ...
    public static Shake Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is Shake)
              return scriptableRendererData.rendererFeatures[i] as Shake;
          }
        }
    ...
    /// <remarks> This function use Reflection, so it can be slow. </remarks>
    private static Shake[] Instances
    {
      get
      {
