  ...
  public sealed partial class Shake
  {
    ...
    private sealed class RenderPass : ScriptableRenderPass
    {
      ...
      private static class ShaderIDs
      {
        ...
        public static readonly int ShakeFrequency = Shader.PropertyToID("_ShakeFrequency");
        public static readonly int ShakeAberration = Shader.PropertyToID("_ShakeAberration");
        public static readonly int ShakeDistort = Shader.PropertyToID("_ShakeDistort");
        public static readonly int NoiseStrength = Shader.PropertyToID("_NoiseStrength");
        public static readonly int NoiseFrequency = Shader.PropertyToID("_NoiseFrequency");
      ...
      private void UpdateMaterial()
      {
        ...
        material.SetFloat(ShaderIDs.Progress, settings.progress);
        material.SetVector(ShaderIDs.Direction, settings.direction);
        material.SetFloat(ShaderIDs.Zoom, settings.zoom);
        material.SetFloat(ShaderIDs.ShakeStrength, settings.shakeStrength * 0.1f);
        material.SetFloat(ShaderIDs.ShakeFrequency, settings.shakeFrequency);
        material.SetVector(ShaderIDs.ShakeAberration, settings.shakeAberration * 200.0f);
        material.SetFloat(ShaderIDs.ShakeDistort, settings.shakeDistort * 100.0f);
        material.SetFloat(ShaderIDs.NoiseStrength, settings.noiseStrength);
        material.SetFloat(ShaderIDs.NoiseFrequency, settings.noiseFrequency);
      ...
      public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
      {
        ...
        renderGraph.AddBlitPass(pass, $"{Constants.Asset.AssemblyName}.Pass0");
