...
namespace FronkonGames.SpiceUp.Shake
{
  ...
  public sealed class SupportWindow : EditorWindow
  {
    ...
    [MenuItem("Help/Fronkon Games/Spice Up/Shake/Online documentation")]
    public static void OnlineDocumentation() => Application.OpenURL(Constants.Support.Documentation);

    [MenuItem("Help/Fronkon Games/Spice Up/Shake/Leave a review ❤️")]
    public static void LeaveAReview() => Application.OpenURL(Constants.Support.Store);

    [MenuItem("Help/Fronkon Games/Spice Up/Shake/Support && suggestions")]
