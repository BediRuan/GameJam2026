...
namespace cowsins2D
{
    public class UIController : MonoBehaviour
    {
        ...
        public void UpdateWeaponInformation()
        {
            ...
            if (weaponController.weapon == null || weaponController.id == null)
            {
            ...
            int currentBullets = weaponController.id ? weaponController.id.currentBullets : 0;
            ...
            bulletsUI.text = weaponController.weapon.infiniteBullets ? "infinite" : weaponController.id.currentBullets.ToString();
            ...
            magazineUI.text = weaponController.weapon.infiniteBullets ? "" : weaponController.weapon.limitedMagazines ? weaponController.id.totalBullets.ToString() : weaponController.weapon.magazineSize.ToString();
        }
